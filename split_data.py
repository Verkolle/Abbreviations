...
input_abbrev = "output/dataset/maskarpone/cit.txt"
input_fulltext = "output/dataset/maskarpone/citrons.txt"

# Output dataset locations
output_dir = "output/dataset/maskarpone/div/"
# short = "abbrev"
# fullt = "fulltext"
...
def splitter(data_abbrev, data_fulltext, o_d, s, f):
    ...
    # print("Dataset split! Writing output!")
...
# For testing purposes split_main function call
# split_main(input_abbrev, input_fulltext, output_dir, short, fullt)
